function Info() {
   return <div className="Info">
      ...
      <p><span>Vēlamais laiks apmeklējumiem: </span>darba dienās plkst.11:00-17:00.</p>
      <p><span>Adrese: </span>Rīga, Matīsa iela 65, LV- 1009.</p>
      <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgnL-6fb5PhgkCkH3odiqgPmhqoWm6HeRjwQ&amp;usqp=CAU"></img>
